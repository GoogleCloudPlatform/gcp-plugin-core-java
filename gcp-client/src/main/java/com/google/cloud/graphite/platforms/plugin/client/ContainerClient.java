...
public class ContainerClient {
   ...
   *     "sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef". The container
   *     can be specified either by "gcr.io/example-project/example:latest" or
  ...
  public String getDigest(final String resourceUri, final String tag) throws IOException {
    Preconditions.checkArgument(!Strings.isNullOrEmpty(resourceUri));
    Preconditions.checkArgument(resourceUri.split("/").length >= 3);
